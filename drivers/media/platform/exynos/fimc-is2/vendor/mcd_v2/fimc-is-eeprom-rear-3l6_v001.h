...
/* Reference File
 * Universal EEPROM map data V001_20180703_for Universal EEPROM map data V001_20190109_for A10_LassenP_DW9808_10K_EEPROM_(3L6_13M).xlsx
 */

#define FIMC_IS_REAR_MAX_CAL_SIZE (10 * 1024)
struct rom_ae_cal_data rear_3l6_ae_cal_info = {	0x2220,         // int32_t  rom_header_main_ae_start_addr 	0x225F,           // int32_t  rom_header_main_ae_end_addr	0x2680,         // int32_t  rom_ae_module_info_start_addr 	0x269C,         // int32_t  rom_ae_checksum_addr 	(0x225F - 0x2220 +1),       // int32_t  rom_ae_checksum_len     (40)};const struct rom_extend_cal_addr rear_3l6_extend_cal_addr = {	EXTEND_AE_CAL,              // char* name	&rear_3l6_ae_cal_info,      // void* data	NULL,                       // struct rom_extend_cal_addr* next};
const struct fimc_is_vender_rom_addr rear_3l6_cal_addr = {
	/* Set '-1' if not used */

	'B',				//char			camera_module_es_version;
	...
	0x52,			//int32_t		rom_header_main_mtf_data_addr;
	...
	0x0200,				//int32_t		rom_awb_module_info_start_addr;
	0x023C,				//int32_t		rom_awb_checksum_addr;
	(0x21F-0x200+1),		//int32_t		rom_awb_checksum_len; (32)

	0x240,				//int32_t		rom_shading_module_info_start_addr;
	...
	0x1C50,				//int32_t		rom_pdaf_module_info_start_addr;
	0x221C,				//int32_t		rom_pdaf_checksum_addr;
	(0x21FF-0x1C50+1),				//int32_t		rom_pdaf_checksum_len;  (1456)
	...
	&rear_3l6_extend_cal_addr,				//void*			extended_cal_addr;
};
#endif
