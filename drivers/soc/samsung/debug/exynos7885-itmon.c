 ...
 *
 * IPs Traffic Monitor(ITMON) Driver for Samsung Exynos7885 SOC
...
static struct itmon_rpathinfo rpathinfo[] = {
	/* Data BUS */
	{0,	"G3D",		"NRT_MEM",	GENMASK(3, 0),	4},
	{1,	"MFCMSCL",	"NRT_MEM",	GENMASK(3, 0),	4},
	{2,	"FSYS",		"NRT_MEM",	GENMASK(3, 0),	4},
	{3,	"APM",		"NRT_MEM",	GENMASK(3, 0),	4},
	{4,	"GNSS",		"NRT_MEM",	GENMASK(3, 0),	4},
	{5,	"CSSYS",	"NRT_MEM",	GENMASK(3, 0),	4},
	{6,	"ISP",		"NRT_MEM",	GENMASK(3, 0),	4},
	{7,	"ISP",		"NRT_MEM",	GENMASK(3, 0),	4},
	{8,	"WLBT",		"NRT_MEM",	GENMASK(3, 0),	4},

	{0,	"CP",		"RT_MEM",	GENMASK(3, 0),	4},
	{1,	"CAM",		"RT_MEM",	GENMASK(3, 0),	4},
	{2,	"DPU",		"RT_MEM",	GENMASK(3, 0),	4},
	{3,	"ABOX",		"RT_MEM",	GENMASK(3, 0),	4},
	{4,	"WLBT",		"RT_MEM",	GENMASK(3, 0),	4},
	{5,	"GNSS",		"RT_MEM",	GENMASK(3, 0),	4},
	{6,	"ISP",		"RT_MEM",	GENMASK(3, 0),	4},
	{7,	"ISP",		"RT_MEM",	GENMASK(3, 0),	4},

	{0,	"G3D",		"PERI",		GENMASK(3, 0),	4},
	{1,	"MFCMSCL",	"PERI",		GENMASK(3, 0),	4},
	{2,	"ABOX",		"PERI",		GENMASK(3, 0),	4},
	{3,	"WLBT",		"PERI",		GENMASK(3, 0),	4},
	{4,	"CP",		"PERI",		GENMASK(3, 0),	4},
	{5,	"FSYS",		"PERI",		GENMASK(3, 0),	4},
	{6,	"APM",		"PERI",		GENMASK(3, 0),	4},
	{7,	"GNSS",		"PERI",		GENMASK(3, 0),	4},
	{8,	"CSSYS",	"PERI",		GENMASK(3, 0),	4},
	{9,	"ISP",		"PERI",		GENMASK(3, 0),	4},
	{10,	"ISP",		"PERI",		GENMASK(3, 0),	4},
	{11,	"CAM",		"PERI",		GENMASK(3, 0),	4},
	{12,	"DPU",		"PERI",		GENMASK(3, 0),	4},
};
...
static struct itmon_masterinfo masterinfo[] = {
	...
	/* BLK_ISP */
	{"ISP",		0,				"ISP",		GENMASK(3, 1)},
	{"ISP",		BIT(1),				"VRA",		GENMASK(3, 1)},
	{"ISP",		BIT(2),				"GDC",		GENMASK(3, 1)},
	{"ISP",		0,				"MCSC",		0},
	...
	/* BLK_CAM */
	{"CAM",		0,				"CSISX4",	GENMASK(2, 1)},
	{"CAM",		BIT(1),				"3AA0",		GENMASK(2, 1)},
	{"CAM",		BIT(2),				"3AA1",		GENMASK(2, 1)},
...
static struct itmon_nodeinfo data_path[] = {
	...
	{M_NODE, "CP",			0x124B3000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "CSSYS",		0x12433000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "DPU",			0x12443000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "FSYS",		0x12453000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "G3D",			0x12463000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "GNSS",		0x12473000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "ISP",			0x12483000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "ISP",			0x12493000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "MFCMSCL",		0x124A3000, NULL, 0,	   false, false,  true, true, false},
	{M_NODE, "WLBT",		0x124C3000, NULL, 0,	   false, false,  true, true, false},
	{S_NODE, "NRT_MEM0",		0x124D3000, NULL, TMOUT,   true,  false,  true, true, false},
	{S_NODE, "NRT_MEM1",		0x124E3000, NULL, TMOUT,   true,  false,  true, true, false},
	{S_NODE, "PERI",		0x12513000, NULL, TMOUT,   true,  false,  true, true, false},
...
static struct itmon_nodeinfo peri_path[] = {
	{M_NODE, "CP_TO_SFR",		0x12613000, NULL, 0,	   false, false, true, true, false},
	{M_NODE, "CPU_TO_SFR",		0x12603000, NULL, 0,	   false, false, true, true, false},
	{M_NODE, "PERI_TO_SFR",		0x12623000, NULL, 0,	   false, false, true, true, false},
	{S_NODE, "APM_SFR",		0x126F3000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CAM_SFR",		0x12633000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CORE_SFR",		0x126E3000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CORE_SFR_TREX",	0x126D3000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CPU_CL0_SFR",		0x12643000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CPU_CL1_SFR",		0x12653000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CPU_CL2_SFR",		0x12663000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "CSSYS_SFR",		0x12703000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "DISP_AUD_SFR",	0x12673000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "FSYS_SFR",		0x126A3000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "G3D_SFR",		0x12693000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "GIC_SFR",		0x12713000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "ISP_SFR",		0x12683000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "MFCMSCL_SFR",		0x126B3000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "MIF0_SFR",		0x12723000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "MIF1_SFR",		0x12733000, NULL, TMOUT,   true,  false, true, true, false},
	{S_NODE, "PERI_SFR",		0x126C3000, NULL, TMOUT,   true,  false, true, true, false},
};
