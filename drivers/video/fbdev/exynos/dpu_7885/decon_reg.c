...
#else
	/* Values are rounded off to previous integer to remove compilation error ([-Werror)
	 Without [-Werror] values are being rounded off to previous integer value,
	 so it should work as previous
	*/
