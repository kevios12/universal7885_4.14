...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_VBUS_CHECK,
	POWER_SUPPLY_PROP_OTG_CHECK,
	POWER_SUPPLY_PROP_SET_UVLO,
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_HV_MAINS_12V,			/* 23 */
	POWER_SUPPLY_TYPE_HV_PREPARE_MAINS, 		/* 24 */
	POWER_SUPPLY_TYPE_HV_ERR,			/* 25 */
	POWER_SUPPLY_TYPE_MHL_USB_100,			/* 26 */
	POWER_SUPPLY_TYPE_MHL_2000, 			/* 27 */
	POWER_SUPPLY_TYPE_HV_UNKNOWN,			/* 28 */
	POWER_SUPPLY_TYPE_MDOCK_TA, 			/* Mdock charger(29) */
	POWER_SUPPLY_TYPE_HMT_CONNECTED,		/* 30 */
	POWER_SUPPLY_TYPE_HMT_CHARGE,			/* 31 */
	POWER_SUPPLY_TYPE_WIRELESS_PACK,		/* 32 */
	POWER_SUPPLY_TYPE_WIRELESS_PACK_TA,		/* 33 */
	POWER_SUPPLY_TYPE_WIRELESS_STAND,       /* 34 */
	POWER_SUPPLY_TYPE_WIRELESS_HV_STAND,    /* 35 */
	POWER_SUPPLY_TYPE_PDIC,             	/* 36 */
	POWER_SUPPLY_TYPE_HV_MAINS_CHG_LIMIT,	/* 37 */
	POWER_SUPPLY_TYPE_HV_QC20,			/* 38 - ILIM 1.8A - CHG 3.0A */
	POWER_SUPPLY_TYPE_HV_QC30,			/* 39 - ILIM 3.0A - CHG 3.5A (Step Charging 4.2A -> 3.0A) */
